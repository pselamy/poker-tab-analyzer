...
describe('PokerSolver', () => {
  ...
  describe('win probability', () => {
    it('should decrease with more players', () => {
      ...
      expect(result2Players.winProbability).toBeGreaterThan(result6Players.winProbability);
      expect(result6Players.winProbability).toBeGreaterThan(result9Players.winProbability);
    });
